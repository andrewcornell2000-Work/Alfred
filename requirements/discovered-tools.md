...
*Tools and MCPs found by Alfred's growth loop — things you wouldn't think to search for.*
...
*Entries below are added by the nightly growth loop. Empty until first discovery run ships.*
