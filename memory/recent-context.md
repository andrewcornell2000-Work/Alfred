...
- **Outstanding bugs:** (1) `"claude"` provider token normalisation, (2) Tavily `needs_search` gate for weather/current-event GENERAL queries, (3) Codex TTY error, (4) CLAUDE_EXECUTION category alignment.
