> **DEPRECATED (2026-07-04):** Scheduled daily loop disabled. Use `docs/LEARNING-WORKFLOW.md` for Cursor-based learning. Kept for reference and emergency manual workflow dispatch.
