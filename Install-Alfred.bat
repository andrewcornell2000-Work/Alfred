...
:: Refresh PATH from Windows before checking installed tools.
...
if "%SETUP_EXIT%"=="3" (
    echo [ACTION REQUIRED] Required tooling is missing.
    echo.
    echo   Install or repair Git, Node.js 18+, npm, Claude Code CLI, and Codex CLI.
    echo   Then double-click Install-Alfred.bat again.
    echo.
    pause
    exit /b 3
